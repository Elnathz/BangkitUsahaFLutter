...
import 'package:bangkit_usaha/features/shop/pages/shop_order_list_screen.dart';
...
class _ShopProfileScreenState extends State<ShopProfileScreen> with SingleTickerProviderStateMixin {
      ...
      body: DefaultTabController(
        ...
        child: NestedScrollView(
          headerSliverBuilder: (context, innerBoxIsScrolled) {
            return [
              SliverAppBar(
                expandedHeight: (currentUser?.uid == widget.shopId) ? 280 : 220, // Lebih tinggi jika owner
                floating: false,
                pinned: true,
  ...
  Widget _buildShopHeader(Color primaryColor) {
    return StreamBuilder<DocumentSnapshot>(
      stream: FirebaseFirestore.instance.collection('users').doc(widget.shopId).snapshots(),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(" $rating / 5.0", style: const TextStyle(color: Colors.white, fontSize: 12)),
                          ],
                        ),
                      ],
                    ),
                ...
                Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const ShopOrderListScreen()),
                      );
                    },
                    child: Container(
                      ...
                      child: Row(
                        children: const [
                          Icon(LucideIcons.listOrdered, color: Colors.white, size: 20),
                          SizedBox(width: 12),
                          Expanded(
                            child: Text("Kelola Pesanan Masuk", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                          ),
