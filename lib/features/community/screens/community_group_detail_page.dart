...
class _CommunityGroupDetailPageState extends State<CommunityGroupDetailPage> {
  ...
  // ChatService instance removed (not used in this state)
  ...
  void _handleLike(Post post) {
    ...
    _showToast(
      post.isLiked ? 'Like dibatalkan' : 'Post disukai! ❤️',
  ...
  void _handleShare(Post post) {
    showModalBottomSheet(
      ...
      isScrollControlled: true,
      builder: (context) =>
          ShareBottomSheet(postUrl: 'https://bangkitumkm.app/post/${post.id}'),
    );
  }
...
class _PostCard extends StatelessWidget {
  ...
  // _buildStatItem removed (not referenced)
}
                ...
                Expanded(
                  child: Container(
                    ...
                    child: ElevatedButton(
                      onPressed:
                          _contentController.text.trim().isEmpty || _isUploading
                          ? null
                          : _submit,
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.transparent,
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _InviteChatTile(
                      ...
                      onTap: (name) =>
                          _handleSendInvite(chatRoom.id, name, partnerId),
                    );
                  },
                );
              },
