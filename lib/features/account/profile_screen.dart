...
class _ProfileScreenState extends State<ProfileScreen> {
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData) {
          for (var doc in snapshot.data!.docs) {
            ...
            else if (status == 'Diproses') packing++; // Assuming 'Diproses' maps to Packed
            else if (status == 'Diantar') shipping++;
            else if (status == 'Selesai') completed++;
          }
        }
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    Expanded(child: Center(child: _buildOrderIcon(context, "Menunggu", pending, LucideIcons.shoppingBag, Colors.amber, Colors.amber[50]!))),
                    const SizedBox(width: 8), 
                    Expanded(child: Center(child: _buildOrderIcon(context, "Dikemas", packing, LucideIcons.package, Colors.blue, Colors.blue[50]!))),
                    const SizedBox(width: 8), 
                    Expanded(child: Center(child: _buildOrderIcon(context, "Dikirim", shipping, LucideIcons.truck, Colors.purple, Colors.purple[50]!))),
                    const SizedBox(width: 8), 
                    Expanded(child: Center(child: _buildOrderIcon(context, "Selesai", completed, LucideIcons.checkCircle, Colors.green, Colors.green[50]!))),
                  ],
                ),
              ],
            ),
  ...
  Widget _buildOrderIcon(BuildContext context, String label, int count, IconData icon, Color color, Color bgColor) {
        ...
        child: Column(
          ...
          children: [
            ...
            if (isEditing) ...[
              ...
              const SizedBox(height: 12),
              _buildEditInput("Alamat", _addressController, icon: LucideIcons.mapPin),
              const SizedBox(height: 12),
              _buildEditInput("Telepon", _phoneController, icon: LucideIcons.phone),
              const SizedBox(height: 12),
              _buildEditInput("Email", _emailController, icon: LucideIcons.mail),
              const SizedBox(height: 12),
              _buildEditInput("Berdiri Sejak", _yearController, icon: LucideIcons.store),
              const SizedBox(height: 16),
              ...
              const SizedBox(height: 16),
              _buildInfoRow(LucideIcons.mapPin, "Alamat", businessProfile['address']),
              _buildInfoRow(LucideIcons.phone, "Telepon", businessProfile['phone']),
              _buildInfoRow(LucideIcons.mail, "Email", businessProfile['email']),
              _buildInfoRow(LucideIcons.clock, "Jam Operasional", businessProfile['openingHours']),
              _buildInfoRow(LucideIcons.calendar, "Berdiri Sejak", businessProfile['established']),
            ],
          ],
        ),
      ),
  ...
  Widget _buildReviewItem(String name, String avatarUrl, int rating, String comment, String date) {
    return Container(
