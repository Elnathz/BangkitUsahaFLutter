        ...
        builder: (context, snapshot) {
          ...
          for (var doc in docs) {
            if (_selectedItems.contains(doc.id)) {
              // doc.id is usually productId based on MarketService
              var data = doc.data() as Map<String, dynamic>;
                        ...
                        ...items.map((doc) {
                          ...
                          return Card(
                            ...
                            child: Padding(
                              ...
                              // Removed invalid onPressed from Padding. Use IconButton above for delete.
                            ),
                          );
                        }),
